...
`docs/plans/2026-07-14-agent-guidance-propagation-plan.md`.) Note: this skill
governs the documentation ledger per [DOM-14] — it is unrelated to
Engram's product-level memory coalescing (moments/episodes/arcs).
