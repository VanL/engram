...
its named exit (engineering principle §11 — this repo's numbering), declared deviations,
...
(engineering principle §13 — this repo's numbering) and carries an executable gate: a
