...
ENV_WEFT_PROJECT_CONFIG_PATH: Final[str] = "ENGRAM_PROJECT_CONFIG_PATH"
ENV_WEFT_PROJECT_CONFIG_NAME: Final[str] = "ENGRAM_PROJECT_CONFIG_NAME"
...
EMBEDDED_WEFT_ENV_MAPPING: Final[dict[str, str]] = {
    ...
    ENV_WEFT_PROJECT_CONFIG_PATH: "WEFT_PROJECT_CONFIG_PATH",
    ENV_WEFT_PROJECT_CONFIG_NAME: "WEFT_PROJECT_CONFIG_NAME",
...
def load_embedded_weft_overrides(vault_path: str | Path) -> dict[str, Any]:
    ...
    overrides["WEFT_PROJECT_CONFIG_PATH"] = resolved_vault_path.name
    overrides["WEFT_PROJECT_CONFIG_NAME"] = "broker.toml"
    return overrides
